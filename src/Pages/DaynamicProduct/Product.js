...
const Product = ({ product, setItems }) => {

  const { img, catagori, condition, name, title, location, orginal_price, resale_price, year, status, time } = product
      ...
      <div className="card card-compact bg-base-100 shadow-xl">
        ...
        <div className="card-body">
          ...
          <div className="card-actions mt-5 justify-between">
            ...
            <label onClick={() => setItems(product)} htmlFor="book-modal" className="btn bg-gradient-to-r from-violet-500 to-fuchsia-500">Book now</label>
